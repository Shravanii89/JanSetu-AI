...
// JanSetu AI - Error Boundary for Citizen Grievance Intake
...
export default function Error({
  ...
  useEffect(() => {
    console.error("Error in Citizen Grievance Intake:", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[400px] items-center justify-center p-6">
      <div className="rounded-xl border border-rose-200 bg-rose-50 p-6 text-center max-w-md">
        ...
        <p className="mt-2 text-xs text-rose-700">{error.message || "An unexpected error occurred in Citizen Grievance Intake."}</p>
        <button
          onClick={() => reset()}
