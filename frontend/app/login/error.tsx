...
// JanSetu AI - Error Boundary for Official Government Access
...
export default function Error({
  ...
  useEffect(() => {
    console.error("Error in Official Government Access:", error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[400px] items-center justify-center p-6">
      <div className="rounded-xl border border-rose-200 bg-rose-50 p-6 text-center max-w-md">
        ...
        <p className="mt-2 text-xs text-rose-700">{error.message || "An unexpected error occurred in Official Government Access."}</p>
        <button
          onClick={() => reset()}
