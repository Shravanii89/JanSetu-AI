// JanSetu AI - Incident Details & Master Ticket
...
export default function Page() {
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      <OfficialNavbar title="Incident Details & Master Ticket" />
      <div className="container mx-auto p-6 max-w-7xl flex-1">
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <h1 className="text-2xl font-bold text-slate-900">Incident Details & Master Ticket</h1>
          <p className="mt-2 text-sm text-slate-600">Master incident details and linked grievances.</p>
