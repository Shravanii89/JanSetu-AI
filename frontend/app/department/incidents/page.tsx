// JanSetu AI - Department Incidents
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-slate-900">Department Incidents</h1>
        <p className="mt-2 text-sm text-slate-600">Incidents affecting the officer's jurisdiction.</p>
