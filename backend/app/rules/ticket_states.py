...
ALLOWED_TRANSITIONS: Dict[str, List[str]] = {
    NEW: [AI_ANALYZED, NEEDS_CLARIFICATION, READY_FOR_ROUTING, REJECTED, SPAM, ASSIGNED],
    AI_ANALYZED: [NEEDS_CLARIFICATION, AWAITING_CITIZEN, READY_FOR_ROUTING, ASSIGNED, ESCALATED, DUPLICATE, SPAM],
    NEEDS_CLARIFICATION: [AWAITING_CITIZEN, READY_FOR_ROUTING, REJECTED, ASSIGNED],
    AWAITING_CITIZEN: [READY_FOR_ROUTING, NEEDS_CLARIFICATION, REJECTED, ASSIGNED],
    READY_FOR_ROUTING: [ASSIGNED, IN_PROGRESS, ESCALATED],
    ASSIGNED: [IN_PROGRESS, ESCALATED, RESOLVED, ASSIGNED],
    IN_PROGRESS: [RESOLVED, ESCALATED, NEEDS_CLARIFICATION, ASSIGNED],
    ESCALATED: [IN_PROGRESS, RESOLVED, CLOSED, ASSIGNED],
